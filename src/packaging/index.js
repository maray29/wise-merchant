...
// // Initial resize to match the current window size

// app.load('https://prod.spline.design/pPoPblCfwPLTPNhl/scene.splinecode').then(() => {
//   const jar = app.findObjectByName('jar');
//   const tinCan = app.findObjectByName('tin-can');
//   const vape = app.findObjectByName('vape');
//   const pouch = app.findObjectByName('pouch');
//   const drinkCan = app.findObjectByName('drink-can');

//   const objects = [jar, tinCan, vape, pouch, drinkCan];
...
import { animatePinnedSection } from '$animation/animation.js';
